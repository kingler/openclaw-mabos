...
| IRC ideation/research chain (idea→research→validate→BMC→CompanyDNA, upstream of GDC) | [src/ideation/](extensions/mabos/extensions-mabos/src/ideation/)                                          | ideation-\* (7 test files, 30 tests)                                                                                    | Phase 1 backend done 2026-05-28; analyst-only backend default; UI pending |
