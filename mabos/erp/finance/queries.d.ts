...
export declare function recordPayment(
  pg: PgClient,
  params: {
    invoice_id: string;
    amount: number;
...
export declare function postLedgerEntry(
  pg: PgClient,
  params: {
...
export declare function profitLoss(
  pg: PgClient,
  from: string,
  to: string,
): Promise<{
...
export declare function listAccounts(
  pg: PgClient,
  params: {
    type?: string;
    limit?: number;
...
export declare function cashFlowStatement(
  pg: PgClient,
  from: string,
  to: string,
): Promise<{
...
export declare function expenseReport(
  pg: PgClient,
  from: string,
  to: string,
): Promise<{
...
export declare function budgetVsActual(
  pg: PgClient,
  from: string,
  to: string,
): Promise<{
