...
- [Developer Guide](extensions/mabos/extensions-mabos/docs/developer-guide.md) — set up, run, configure, extend, and test MABOS
- [TypeDB Knowledge Graph](extensions/mabos/extensions-mabos/docs/typedb-knowledge-graph.md) — ontology graph store + local Docker setup
